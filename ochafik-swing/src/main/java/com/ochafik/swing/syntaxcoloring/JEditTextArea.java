...
public class JEditTextArea extends JComponent
{
	...
	public int lineToBottomY(int line)
	{
		FontMetrics fm = painter.getFontMetrics();
		return (line - firstLine) * fm.getHeight()
			+ (fm.getLeading()+ fm.getAscent()+ fm.getMaxDescent());
	}
...
//			Toolkit toolkit = 
	...
	public void processKeyEvent(KeyEvent evt)
	{
		...
		if (inputMap==null) inputMap=getInputMap();
		Object o=inputMap.get(KeyStroke.getKeyStrokeForEvent(evt));
		if (o!=null) {
			if (actionMap==null) actionMap=getActionMap();
			Object a=actionMap.get(o);
			//System.out.println(o+" => "+a);
			if (a!=null) ((Action)a).actionPerformed(new ActionEvent(this,ActionEvent.ACTION_PERFORMED,o.toString(),evt.getModifiers()));
		}
		
	}
	InputMap inputMap;
	ActionMap actionMap;
	/*public void setActionMap2(ActionMap am) {
		actionMap=am;
	}
	public void setInputMap2(InputMap im) {
		inputMap=im;
	}*/
	// protected members
	...
	protected void documentChanged(DocumentEvent evt)
	{
		...
		propertyChangeSupport.firePropertyChange(DOCUMENT_PROPERTY,null,null);
	}
	public static final String DOCUMENT_PROPERTY="doc"; 
	PropertyChangeSupport propertyChangeSupport;
	public void addDocumentChangeListener(PropertyChangeListener l) {
		propertyChangeSupport.addPropertyChangeListener(DOCUMENT_PROPERTY,l);
	}
